...
if __name__ == '__main__':
    ...
    time.sleep(0.5)
    os.system("nmcli con delete {}".format(hotspot_conn_name))
    os.system("nmcli con add type wifi ifname {} con-name {} autoconnect yes ssid {} mode ap".format(hotspot_interface, hotspot_conn_name,hotspot_ssid, hotspot_password))
